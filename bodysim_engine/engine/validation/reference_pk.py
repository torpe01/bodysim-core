...
REFERENCE_PK = {
    ...
    "Atorvastatin":   {
        ...
        "logp": 4.06, "fup": 0.02, "mw": 558.6, "pka": 4.46, "drug_type": "acidic", "dose": 40, "route": "oral", "cmax": 0.012, "auc": 0.08, "ka": 1.5, "F": 0.14, "clint": 4.2, "clrenal": 0.1, 
        "is_uptake_substrate": True, "vmax_uptake": 500.0, "km_uptake": 3.0
    },
    ...
    "Furosemide":     {"smiles": "NS(=O)(=O)c1cc(Cl)c(cc1C(=O)O)NCc2occc2", "logp": 2.03, "fup": 0.02, "mw": 330.7, "pka": 3.90, "drug_type": "acidic", "dose": 40, "route": "oral", "cmax": 1.1, "auc": 3.4, "ka": 1.3, "F": 0.61, "clint": 2.0, "clrenal": 8.0},
    "Metoprolol":     {"smiles": "COCc1ccc(cc1)OCC(O)CNC(C)C", "logp": 1.88, "fup": 0.87, "mw": 267.4, "pka": 9.68, "drug_type": "basic", "dose": 100, "route": "oral", "cmax": 0.12, "auc": 0.85, "ka": 1.5, "F": 0.38, "clint": 80.0, "clrenal": 0.4},
    ...
    "Propranolol":    {"smiles": "CC(C)NCC(O)COc1cccc2ccccc12", "logp": 3.48, "fup": 0.13, "mw": 259.3, "pka": 9.42, "drug_type": "basic", "dose": 40, "route": "oral", "cmax": 0.04, "auc": 0.35, "ka": 1.7, "F": 0.26, "clint": 300.0, "clrenal": 0.1},
    "Rosuvastatin":   {
        "smiles": "CC(C)N(C)c1nc(nc(c1/C=C/[C@@H](O)C[C@@H](O)CC(=O)O)c2ccc(F)cc2)S(=O)(=O)C", 
        "logp": -0.33, "fup": 0.12, "mw": 481.5, "pka": 4.20, "drug_type": "acidic", "dose": 20, "route": "oral", "cmax": 0.015, "auc": 0.12, "ka": 1.4, "F": 0.20, "clint": 1.2, "clrenal": 0.8, 
        "is_uptake_substrate": True, "vmax_uptake": 600.0, "km_uptake": 2.5
    },
    "Warfarin":       {
        "smiles": "CC(=O)CC(c1ccccc1)c2c(O)c3ccccc3oc2=O", 
        "logp": 2.70, "fup": 0.007, "mw": 308.3, "pka": 5.08, "drug_type": "acidic", "dose": 10, "route": "oral", "cmax": 1.1, "auc": 45.0, "ka": 1.2, "F": 0.93, "clint": 4.5, "clrenal": 0.05,
        "Vmax_hepatic": 50.0, "Km_hepatic": 5.0
    },
    ...
    "Phenytoin":      {
        ...
        "logp": 2.47, "fup": 0.10, "mw": 252.3, "pka": 8.33, "drug_type": "neutral", "dose": 300, "route": "oral", "cmax": 4.5, "auc": 110.0, "ka": 1.0, "F": 0.85, "clint": 6.0, "clrenal": 0.1, 
        "Vmax_hepatic": 40.0, "Km_hepatic": 10.0
    },
    ...
    "Metformin":      {"smiles": "CN(C)C(=N)NC(=N)N", "logp": -1.43, "fup": 0.97, "mw": 129.21, "pka": 11.5, "drug_type": "basic", "dose": 500, "route": "oral", "cmax": 1.3, "auc": 10.5, "ka": 1.8, "F": 0.55, "clint": 0.1, "clrenal": 30.6},
